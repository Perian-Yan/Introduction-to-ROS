  ...
  nodeHandle_(nodeHandle) 
{
  ...
  if(!nodeHandle_.getParam("service_name", service_name)) 
    {
      ROS_ERROR("Could not find the service name parameter!");
    }
  ...
  service = nodeHandle_.advertiseService(service_name, &SmbHighlevelController::StopCallback, this);
}
                                      ...
                                      std_srvs::SetBool::Response &response)
{
  ...
  if(stop)
    response.message = "The robot stops!";
  else
    response.message = "The robot starts!";
  return true;
}
